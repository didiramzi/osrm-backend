...
bool areParallel(const std::vector<Coordinate> &lhs, const std::vector<Coordinate> &rhs)
{
    ...
    std::cout << "Slopes: " << slope_lhs << " " << slope_rhs << std::endl;
    std::cout << "Regression Lhs: " << print_coord(regression_lhs.first) << " " << print_coord(regression_lhs.second) << std::endl;
    std::cout << "Regression Rhs: " << print_coord(regression_rhs.first) << " " << print_coord(regression_rhs.second) << std::endl;
    #endif
